...
var G__13817 = o;
(G__13817[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__13819__i < G__13819__a.length) {G__13819__a[G__13819__i] = arguments[G__13819__i + 0]; ++G__13819__i;}
  args = new cljs.core.IndexedSeq(G__13819__a,0);
} 
...
var G__13825 = jsprops;
(G__13825["defaultValue"] = value);

(G__13825["onChange"] = ((function (G__13825,v,value,on_change){
return (function (p1__13823_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__13823_SHARP_);
});})(G__13825,v,value,on_change))
);
...
var vec__13832 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__13832,(0),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13837 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___13837 == null)){
} else {
var key_13838 = temp__4661__auto___13837;
(jsprops["key"] = key_13838);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13840 = (new reagent.impl.template.NativeWrapper());
(G__13840["name"] = c);
...
var len__7937__auto___13845 = arguments.length;
var i__7938__auto___13846 = (0);
while(true){
if((i__7938__auto___13846 < len__7937__auto___13845)){
args__7944__auto__.push((arguments[i__7938__auto___13846]));

var G__13847 = (i__7938__auto___13846 + (1));
i__7938__auto___13846 = G__13847;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7945__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13843){
var G__13844 = cljs.core.first.call(null,seq13843);
var seq13843__$1 = cljs.core.next.call(null,seq13843);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13844,seq13843__$1);
});
...
break;
default:
var G__13851 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__13851;
continue;
...
var n__7747__auto___13854 = a.length;
var i_13855 = (0);
while(true){
if((i_13855 < n__7747__auto___13854)){
(a[i_13855] = reagent.impl.template.as_element.call(null,(a[i_13855])));
...
var a = cljs.core.into_array.call(null,s);
var n__7747__auto___13857 = a.length;
var i_13858 = (0);
while(true){
if((i_13858 < n__7747__auto___13857)){
var val_13859 = (a[i_13858]);
if((cljs.core.vector_QMARK_.call(null,val_13859)) && ((reagent.impl.template.key_from_vec.call(null,val_13859) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13858] = reagent.impl.template.as_element.call(null,val_13859));
...
var ctx = ({});
var vec__13864 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__13864,(0),null);
var derefed = cljs.core.nth.call(null,vec__13864,(1),null);
...
var G__13868 = (cljs.core.count.call(null,argv) - first_child);
switch (G__13868) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__13868){
