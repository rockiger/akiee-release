...
var args15800 = [];
var len__7937__auto___15804 = arguments.length;
var i__7938__auto___15805 = (0);
while(true){
if((i__7938__auto___15805 < len__7937__auto___15804)){
args15800.push((arguments[i__7938__auto___15805]));

var G__15806 = (i__7938__auto___15805 + (1));
i__7938__auto___15805 = G__15806;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args15800.length)].join('')));
...
var G__15803 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__15803,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__15803;
}
});
...
var len__7937__auto___15811 = arguments.length;
var i__7938__auto___15812 = (0);
while(true){
if((i__7938__auto___15812 < len__7937__auto___15811)){
args__7944__auto__.push((arguments[i__7938__auto___15812]));

var G__15813 = (i__7938__auto___15812 + (1));
i__7938__auto___15812 = G__15813;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7945__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq15808){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__15809,G__15810,seq15808__$2);
});
...
var file = cljs.core.get.call(null,map__15817__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15817__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15817__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__15817,map__15817__$1,file,line,column){
return (function (p1__15814_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__15814_SHARP_));
});})(map__15817,map__15817__$1,file,line,column))
...
var temp__4657__auto___15819 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___15819)){
var message_15820 = temp__4657__auto___15819;
cljs.core.println.call(null,message_15820);
} else {
}
...
var temp__4657__auto___15821 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___15821)){
var message_15822 = temp__4657__auto___15821;
cljs.core.println.call(null,message_15822);
} else {
}
...
var G__15832 = exception.stack;
var G__15832__$1 = (((G__15832 == null))?null:clojure.string.split_lines.call(null,G__15832));
var G__15832__$2 = (((G__15832__$1 == null))?null:cljs.core.get.call(null,G__15832__$1,depth));
if((G__15832__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__15832__$2);
}
} else {
...
var vec__15833 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__15833,(0),null);
var column = cljs.core.nth.call(null,vec__15833,(1),null);
var vec__15836 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__15836,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__15836,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__15836,(2),null);
...
var m__$1 = (function (){var G__15840 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__15840) {
case "fail":
...
var G__15846 = (function (){var G__15845 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__15845);
} else {
return G__15845;
}
})();
...
return cljs.core.vary_meta.call(null,G__15848,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e15851){var e = e15851;
var G__15852 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__15852) {
...
var vec__15857 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__15857,(0),null);
var types = vec__15857;
...
return cljs.core.map.call(null,(function (p__15869){
var vec__15870 = p__15869;
var ns = cljs.core.nth.call(null,vec__15870,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__15870,(1),null);
return ((function (vec__15870,ns,vars__$1){
return (function (){
...
var G__15873 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__15873) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__15873,env,once_fixtures,each_fixtures,vec__15870,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__15873,env,once_fixtures,each_fixtures,vec__15870,ns,vars__$1){
return (function (){
var seq__15874 = cljs.core.seq.call(null,vars__$1);
var chunk__15875 = null;
var count__15876 = (0);
var i__15877 = (0);
while(true){
if((i__15877 < count__15876)){
var v = cljs.core._nth.call(null,chunk__15875,i__15877);
var temp__4657__auto___15879 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___15879)){
var t_15880 = temp__4657__auto___15879;
each_fixture_fn.call(null,((function (seq__15874,chunk__15875,count__15876,i__15877,t_15880,temp__4657__auto___15879,v,each_fixture_fn,G__15873,env,once_fixtures,each_fixtures,vec__15870,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15880)));
});})(seq__15874,chunk__15875,count__15876,i__15877,t_15880,temp__4657__auto___15879,v,each_fixture_fn,G__15873,env,once_fixtures,each_fixtures,vec__15870,ns,vars__$1))
);
} else {
}

var G__15881 = seq__15874;
var G__15882 = chunk__15875;
var G__15883 = count__15876;
var G__15884 = (i__15877 + (1));
seq__15874 = G__15881;
chunk__15875 = G__15882;
count__15876 = G__15883;
i__15877 = G__15884;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__15874);
if(temp__4657__auto__){
var seq__15874__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__15874__$1)){
var c__7643__auto__ = cljs.core.chunk_first.call(null,seq__15874__$1);
var G__15885 = cljs.core.chunk_rest.call(null,seq__15874__$1);
var G__15886 = c__7643__auto__;
var G__15887 = cljs.core.count.call(null,c__7643__auto__);
var G__15888 = (0);
seq__15874 = G__15885;
chunk__15875 = G__15886;
count__15876 = G__15887;
i__15877 = G__15888;
continue;
} else {
var v = cljs.core.first.call(null,seq__15874__$1);
var temp__4657__auto___15889__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___15889__$1)){
var t_15890 = temp__4657__auto___15889__$1;
each_fixture_fn.call(null,((function (seq__15874,chunk__15875,count__15876,i__15877,t_15890,temp__4657__auto___15889__$1,v,seq__15874__$1,temp__4657__auto__,each_fixture_fn,G__15873,env,once_fixtures,each_fixtures,vec__15870,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15890)));
});})(seq__15874,chunk__15875,count__15876,i__15877,t_15890,temp__4657__auto___15889__$1,v,seq__15874__$1,temp__4657__auto__,each_fixture_fn,G__15873,env,once_fixtures,each_fixtures,vec__15870,ns,vars__$1))
);
} else {
}

var G__15891 = cljs.core.next.call(null,seq__15874__$1);
var G__15892 = null;
var G__15893 = (0);
var G__15894 = (0);
seq__15874 = G__15891;
...
});})(each_fixture_fn,G__15873,env,once_fixtures,each_fixtures,vec__15870,ns,vars__$1))
);
});})(each_fixture_fn,G__15873,env,once_fixtures,each_fixtures,vec__15870,ns,vars__$1))
], null);
